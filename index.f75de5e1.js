...
for (const link of page.querySelectorAll(".menu__link"))link.addEventListener("click", ()=>{
    page.querySelector(".menu").classList.remove("menu--active");
    page.classList.remove("page--overflow");
});
...
for(let i = 1; i <= 5; i++)page.querySelector(`.materials__button--b` + i).addEventListener("click", ()=>slide(page.querySelector(".materials__button--b" + i), "-" + (i - 1) * 100 + "%"));
